...
# O PULO DO GATO NO LUGAR CERTO:
(
    # Espera 10 segundos (tempo do jogo carregar e estabilizar na tela)
    sleep 10
    # Devolve o arquivo para Modo Jogo. Se você der logout no desktop depois, ele volta pra cá!
